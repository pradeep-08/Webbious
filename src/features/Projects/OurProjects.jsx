...
Special thanks to Pradeep for his leadership, Muthu for managing everything so smoothly, and Naveen for delivering a technically flawless and fast-loading site.
    ...
    return (
        <>
            <Helmet>
                <title>Our Projects | Webbious Portfolio</title>
                <meta name="description" content="Browse our portfolio of software, web, and AI projects. See how we’ve helped clients succeed." />
                <link rel="canonical" href="https://webbious.com/projects" />
                <meta name="keywords" content="Web development portfolio, AI projects, client case studies, software development examples, custom web app projects, real-time app solutions" />
                <meta property="og:title" content="Webbious Projects" />
                <meta property="og:description" content="Real-world examples of how we transform ideas into solutions." />
                <script type="application/ld+json">{`
    {
      "@context": "https://schema.org",
      "@type": "WebPage",
      "name": "Projects",
      "url": "https://webbious.com/projects",
      "breadcrumb": {
        "@type": "BreadcrumbList",
        "itemListElement": [
          { "@type": "ListItem", "position": 1, "name": "Home", "item": "https://webbious.com" },
          { "@type": "ListItem", "position": 2, "name": "Projects", "item": "https://webbious.com/projects" }
        ]
      }
    }
  `}</script>
