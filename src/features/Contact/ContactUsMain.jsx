                ...
                {options.map((option) => {
                  ...
                  return (
                    <div
                      ...
                      className={`relative cursor-pointer p-4 border rounded-md text-center transition-all duration-300 flex flex-col items-center space-y-2 ${
                        isSelected
                    ...
                    >
                      <div
                        className={`absolute top-3 right-3 h-5 w-5 flex items-center justify-center rounded-full border-2 ${
                          isSelected
          ...
          {steps.map((_, i) => (
            <div
              ...
              className={`h-3 w-10 rounded-full transition-all duration-300 ${
                step === i + 1 ? "bg-blue-600" : "bg-blue-100"
              }`}
            />
          ))}
        </div>
