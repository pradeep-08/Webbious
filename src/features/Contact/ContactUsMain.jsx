...
const ContactUsMain = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Contact Webbious | Let’s Collaborate</title>
        <meta name="description" content="Get in touch with the Webbious team. Let’s build something amazing together!" />
        <link rel="canonical" href="https://webbious.com/contact" />
        <meta property="og:title" content="Contact Webbious" />
        <meta name="keywords" content="Contact Webbious, tech consultation, web development quote, hire software developer, AI solution request, custom software inquiry" />
        <meta property="og:description" content="We'd love to hear from you. Send us your ideas, questions, or feedback." />
        <script type="application/ld+json">{`
    {
      "@context": "https://schema.org",
      "@type": "WebPage",
      "name": "Contact",
      "url": "https://webbious.com/contact",
      "breadcrumb": {
        "@type": "BreadcrumbList",
        "itemListElement": [
          { "@type": "ListItem", "position": 1, "name": "Home", "item": "https://webbious.com" },
          { "@type": "ListItem", "position": 2, "name": "Contact", "item": "https://webbious.com/contact" }
        ]
      }
    }
  `}</script>
      ...
      <div className="min-h-screen bg-white flex flex-col md:flex-row items-center justify-between pt-20 pb-10 px-6 sm:px-12 md:px-20 xl:px-32 2xl:px-40 max-w-screen-2xl mx-auto gap-14">
        {/* Left Side */}
        <section className="w-full max-w-md text-left">
          <h1 className="text-3xl md:text-4xl font-bold mb-4">
            Hi, have a project in <span className="text-[#1a73e8]">mind</span>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="hidden md:block text-center mb-3">
            <span className="text-[#000000]  text-2xl md:text-2xl font-bold mb-4 ">
              Contact Us
            </span>
          </div>
                  ...
                  <div className="flex flex-wrap gap-4">
                    {options.map((option) => (
                      ...
                      >
                        ...
                        />
                        <span
                          className={`text-sm ${option.title === "Brand Kit"
                            ? "text-purple-600"
                            : "text-gray-900"
                            }`}
                        >
                  ...
                  {options.map((option) => {
                    ...
                    return (
                      <div
                        ...
                        className={`relative cursor-pointer p-4 border rounded-md text-center transition-all duration-300 flex flex-col items-center space-y-2 ${isSelected
                          ? "border-blue-600 shadow"
                          : "border-gray-200 hover:border-blue-400"
                          }`}
                      >
                        <div
                          className={`absolute top-3 right-3 h-5 w-5 flex items-center justify-center rounded-full border-2 ${isSelected
                ...
                <div>
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    {selectedOptions.map((service) => (
                      <span
                        key={service}
                        className="relative text-xs px-3 py-1 bg-blue-100 text-blue-800 rounded-full pr-5"
                      >
                        {service}
                        <button
