...
export default function CareersPage() {
  ...
  return (
    <>
      <Helmet>
        <title>Careers at Webbious | Join Our Team</title>
        <meta name="description" content="Explore exciting tech career opportunities at Webbious. Work with innovators in AI, web, and digital development." />
        <link rel="canonical" href="https://webbious.com/careers" />
        <meta property="og:title" content="Careers at Webbious" />
        <meta name="keywords" content="tech jobs Chennai, react developer jobs, frontend developer careers, software engineering jobs, careers in AI, web development jobs, hiring web developers" />
        <meta property="og:description" content="We’re hiring! Join Webbious and shape the future of digital innovation." />
        <script type="application/ld+json">{`
    {
      "@context": "https://schema.org",
      "@type": "WebPage",
      "name": "Careers",
      "url": "https://webbious.com/careers",
      "breadcrumb": {
        "@type": "BreadcrumbList",
        "itemListElement": [
          { "@type": "ListItem", "position": 1, "name": "Home", "item": "https://webbious.com" },
          { "@type": "ListItem", "position": 2, "name": "Careers", "item": "https://webbious.com/careers" }
        ]
      }
    }
  `}</script>
